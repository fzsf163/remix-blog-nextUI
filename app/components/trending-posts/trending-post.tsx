        ...
        {trending.map((trend, index) => {
          return (
            ...
            >
              <div
                key={index}
                className="col-span-12 flex h-[7rem] md:h-[9rem] w-fit cursor-pointer justify-center gap-0  rounded-xl shadow-lg transition-colors duration-400 ease-in-out light hover:text-white light:bg-blue-400/40 hover:light:bg-blue-400 dark:bg-slate-500 hover:dark:bg-slate-400 lg:col-span-6 xl:items-start "
              >
                <div className="group aspect-auto w-28 overflow-hidden rounded-lg p-2 sm:w-52">
                  <img
                    src={trend.img}
                ...
                <div className="flex h-full max-w-[400px] flex-col items-start justify-between gap-1 p-5">
                  <h1 className="md:text-lg text-start text-xs font-bold capitalize sm:text-sm lg:text-lg xl:text-2xl">
                    {trend.title}
                  </h1>
