...
export default function MotivationalText() {
  return (
    <div
      ...
      className="pointer-events-none relative m-auto h-auto w-[90%] select-none rounded-lg p-4 text-justify text-white sm:text-center md:h-[25rem]"
    >
      <div className="flex h-full items-center justify-center bg-black/20 sm:gap-2">
